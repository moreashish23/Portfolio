          ...
          <div className='flex gap-4 mt-6'>
            {ABOUT_ME.socialLinks.map((item) => (
              <a key={item.label} className='cursor-pointer group' href={item.link}>
                <item.icon className='text-2xl text-secondary transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110 group-hover:translate-[-2px] group-hover:text-primary' />
              </a>
            ))}
          </div>
        </div>
